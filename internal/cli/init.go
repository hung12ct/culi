...
#   - /path/to/repo-b
# import:
#   # merge backend: auto (default) detects OpenAI/Anthropic API keys, then
#   # signed-in Claude/Codex terminals. Also: ollama (free, local - set
#   # merge_model to a local model like qwen3) or none.
#   provider: auto
